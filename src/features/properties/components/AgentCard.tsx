...
export function AgentCard({ agent, propertyId, propertyTitle }: AgentCardProps) {
  return (
    <div className="space-y-6">
      ...
      {/* Always shown, agent or not — a direct way to reach the team even
          when a specific agent is already listed above. */}
      <div className="rounded-2xl border border-border bg-card p-6">
        ...
        <div className="mt-4">
          <RequestInfoButton propertyId={propertyId} propertyTitle={propertyTitle} />
        </div>
      </div>
    </div>
  )
